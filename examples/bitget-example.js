...
(async function() {
    try{
        ...
        // Load Market
        console.log(await bitgetAccount.loadMarkets('USDT'));
        ...
        // Fetch Ticker
        // console.log(await bitgetAccount.fetchTicker('BTC/USDT:USDT'));
        ...
        // console.log(await bitgetAccount.withdraw("USDT", 10, "TFKdmcqZQjxvPiWRktK4rb44efwGYJihxA", null, {
        //     chain: "TRC20",
        // }));
